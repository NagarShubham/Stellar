...
public class AdapterList extends RecyclerView.Adapter<AdapterList.child> {
    ...
    public void onBindViewHolder(@NonNull child child, int i) {
        ...
        child.customername.setText(arrayList.get(i).getCustomer_name());
        child.requrment.setText(arrayList.get(i).getTypeofRequest());
        child.mobile.setText(arrayList.get(i).getMobile());
        child.date.setText(arrayList.get(i).getDay());
        // child.add.setText(arrayList.get(i).getDetails().toString());


        child.source.setText(arrayList.get(i).getSource());
        child.category.setText(arrayList.get(i).getCategory());
        child.totime.setText(arrayList.get(i).getTotime());
        child.fromtime.setText(arrayList.get(i).getFormtime());
        child.compName.setText(arrayList.get(i).getCompanyName());
    ...
    public class child extends RecyclerView.ViewHolder {
        ...
        public child(@NonNull View itemView) {
            ...
            req_btn.setOnClickListener(v -> mClickListener.onItemClick(v, getAdapterPosition()));
            addlead.setOnClickListener(v -> mClickListener.onleadAdd(getAdapterPosition()));
