...
public class Update_ProfileActivity extends AppCompatActivity {
   ...
   private String getimage1 = "select image";
   private String image1_name = "layout1_image1.png";
   ...
   private ProgressDialog progressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog= new ProgressDialog(Update_ProfileActivity.this);
        ...
        pro_image.setOnClickListener(v -> {
...
//                            JSONObject object1 = object.getJSONObject("data");
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                runOnUiThread(() -> {
                                    ...
                                    for (int i1 = 0; i1 < ig.length; i1++) {
                                        if (ig[i1].equals(gender)) {
                                            pro_gender.setSelection(i1);
                                        }
                                    }
    ...
    private void getcity(String et_state) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(() -> Toast.makeText(Update_ProfileActivity.this, "Network Problem", Toast.LENGTH_SHORT).show());
            }
